...
SELECT Country, COUNT(CustomerID) AS NumOfCustomer FROM Customers GROUP BY Country;
...
SELECT Country c,  COUNT(CustomerID) NumOfCustomer FROM Customers GROUP BY Country ORDER BY NumOfCustomer;
