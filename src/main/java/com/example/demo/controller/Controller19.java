...
//			pstmt.setString(2, "1811-11-12 23:50:49");
	...
	public void method5() throws Exception {
		...
		try (
			...
			pstmt.setString(1, "유현우");
			pstmt.setInt(2, 30);
			pstmt.setDouble(3, 100.32);
			pstmt.setDate(4, Date.valueOf("1900-01-01"));
			pstmt.setTimestamp(5, Timestamp.valueOf("1900-01-01 01:01:01"));
	...
	public void method8(
			...
			@RequestParam("birth") LocalDate bitrh,
		...
		try (
			...
			pstmt.setDate(4, Date.valueOf(bitrh));
	...
	public void method13() throws Exception {
		...
		try (
			...
			if (rs.next()) {
				...
				System.out.println("생시 : " + inserted);
			}
		}
	}
